...
BEGIN
    ...
    SET @batch_start_time = GETDATE();
        ...
        TRUNCATE TABLE silver.crm_cust_info; --this will truncate the silver.crm_cust_info table
        ...
        TRUNCATE TABLE silver.crm_prd_info; --this will truncate the silver.crm_prd_info table
        ...
        TRUNCATE TABLE silver.crm_sales_details; --this will truncate the silver.crm_sales_details table
        ...
        TRUNCATE TABLE silver.erp_cust_az12; --this will truncate the silver.erp_cust_az12 table
        ...
        TRUNCATE TABLE silver.erp_loc_a101; --this will truncate the silver.erp_loc_a101 table
        ...
        TRUNCATE TABLE silver.erp_px_cat_g1v2; --this will truncate the silver.erp_px_cat_g1v2 table
    ...
    BEGIN CATCH
        PRINT '----------------------------------'
        PRINT 'An error occurred during loading silver layer: ' + ERROR_MESSAGE();
